...
public class CoinServiceImpl implements CoinService {
    ...
    private static final HttpEntity<String> ENTITY = new HttpEntity<>("parameters", new HttpHeaders());

    public CoinServiceImpl(final CoinRepository coinRepository, final ObjectMapper objectMapper){
    ...
    public String getTradingCoins() throws Exception {
        String url = "https://api.coingecko.com/api/v3/trading";
        RestTemplate restTemplate =new RestTemplate();
        try{
            ResponseEntity<String> response = restTemplate.exchange(url, HttpMethod.GET, ENTITY, String.class);
